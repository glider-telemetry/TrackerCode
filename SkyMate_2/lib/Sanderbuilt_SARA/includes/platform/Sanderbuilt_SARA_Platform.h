...
#ifndef Sanderbuilt_SARA_LIBRARY_SRC_INCLUDES_PLATFORM_Sanderbuilt_SARA_PLATFORM_H_
#define Sanderbuilt_SARA_LIBRARY_SRC_INCLUDES_PLATFORM_Sanderbuilt_SARA_PLATFORM_H_

#include "../Sanderbuilt_SARA_Config.h"

// only "standard" config supported in this release -- namely AVR-based arduino type affairs
#include "Sanderbuilt_SARA_PlatStd.h"
...
#endif /* Sanderbuilt_SARA_LIBRARY_SRC_INCLUDES_PLATFORM_Sanderbuilt_SARA_PLATFORM_H_ */
